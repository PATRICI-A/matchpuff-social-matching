...
public class CategoryController {
    ...
    public ResponseEntity<CategoryResponse> getCategory(@Parameter(description = "ID of the category") @PathVariable UUID categoryId) {
    ...
    @ApiResponse(responseCode = "404", description = "Category not found")
    public ResponseEntity<Void> deleteCategory(@Parameter(description = "ID of the category") @PathVariable UUID categoryId) {
    ...
    public ResponseEntity<TagResponse> getTag(@Parameter(description = "ID of the tag") @PathVariable UUID tagId) {
    ...
    @ApiResponse(responseCode = "404", description = "Category not found")
    public ResponseEntity<List<TagResponse>> getTagsByCategoryId(@Parameter(description = "ID of the category") @PathVariable UUID categoryId) {
    ...
    @ApiResponse(responseCode = "404", description = "Tag not found")
    public ResponseEntity<Void> deleteTag(@Parameter(description = "ID of the tag") @PathVariable UUID tagId) {
